...
import { mockGlobals, simulatePython, resetPythonState } from '../../fixtures/mock-python.js';
import { DEFAULT_CONFIG, createMockBridges, withSandbox } from '../../fixtures/sandbox-test-utils.js';
...
vi.mock('../../../src/repl/pyodide.js', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../../../src/repl/pyodide.js')>();
  return {
    ...actual,
...
import { createSandbox } from '../../../src/repl/sandbox.js';
import { detectWorkerSupport } from '../../../src/repl/pyodide.js';
